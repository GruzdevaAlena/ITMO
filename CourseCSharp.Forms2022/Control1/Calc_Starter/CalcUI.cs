...
namespace SimpleCalculator
{
	...
	public class CalcUI : System.Windows.Forms.Form
    {
        ...
        protected ToolStripMenuItem инженерныйКалькуляторToolStripMenuItem;
		...
		private void InitializeComponent()
		{
            ...
            this.KeySign.Text = "+/-";
            this.toolTip1.SetToolTip(this.KeySign, "Смена знака");
            ...
            this.toolTip1.SetToolTip(this.KeyClear, "Очистка");
            ...
            this.инженерныйКалькуляторToolStripMenuItem.Size = new System.Drawing.Size(275, 26);
